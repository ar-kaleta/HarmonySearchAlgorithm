...
for parameter in range(10, 100, 10):
...
df1.to_excel('C:/Users/Artur/PycharmProjects/Harmony Search Algorithm/data/tests/KP/10_test_BW_parameter.xlsx', index=False)
