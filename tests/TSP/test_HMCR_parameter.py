...
hm_bandwidth = 0.1
for parameter in range(90, 97, 1):
...
df1.to_excel('C:/Users/Artur/PycharmProjects/Harmony Search Algorithm/data/tests/TSP/test_HMCR_parameter_2.xlsx', index=False)
